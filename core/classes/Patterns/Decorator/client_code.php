...
use Core\Patterns\Decorator\DangerousHTMLTagsFilter;
use Core\Patterns\Decorator\InputFormat;
use Core\Patterns\Decorator\MarkdownFormat;
use Core\Patterns\Decorator\PlainTextFilter;
use Core\Patterns\Decorator\TextInput;
...
displayCommentAsAWebsite($filteredInput, $dangerousForumPost); // Выполнится у всех троих типо рекурсивно, прикольно
echo "\n\n\n";